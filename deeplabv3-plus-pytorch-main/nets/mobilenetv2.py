...
BatchNorm2d = nn.BatchNorm2d #正则化输入数据
#该部分为backbone部分

#倒残差结构中的3×3卷积，最开始的那层结构
...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.):
        ...
        input_channel = 32 #输入通道是32
        last_channel = 1280 #输出通道是1280
...
#定义一个mobilenetV2模型，如果pretrained为true则下载预训练好的模型参数，否则下载其余参数
